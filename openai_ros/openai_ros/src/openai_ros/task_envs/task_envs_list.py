...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=100000):
    ...
    # Husarion Robot
        ...
        # register(
        #     id=task_env,
        #     entry_point='openai_ros.task_envs.turtlebot3_gmapping.turtlebot3_gmapping_coverage:GmappingTurtleBot3WorldEnv',
        #     max_episode_steps=5000,    #da-slam:1000   test:15000
        # )
        # from openai_ros.task_envs.turtlebot3_gmapping import turtlebot3_gmapping_coverage
        ...
        from openai_ros.task_envs.turtlebot3_gmapping import turtlebot3_gmapping


    elif task_env == 'largeWorld-v0':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot3_gmapping.large_gmapping:GmappingLargeWorldEnv',
            max_episode_steps=100000,
        )
        # import our training environment
        # from openai_ros.openai_ros.src.openai_ros.task_envs.large_gmapping import large_gmapping_entropy
        from openai_ros.task_envs.turtlebot3_gmapping import large_gmapping
